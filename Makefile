...
${OBJS_DIR}/%.o: %.c
			@mkdir -p ${@D}
			@printf "\033[2K\033[0;35mMINISHELL:    \033[0;33mCompilation...    \033[0;31m%-14.14s\033[0;0m│\r" $(notdir ${<})
			@${CC} ${CFLAGS} -c $< -o $@

${NAME}:	header ${OBJS}
			@printf "\033[2K\033[0;35mMINISHELL\033[0;0m:    \033[0;32mCompleted         \033[0;31m----\033[0;0m          │\r\n"
			@make bonus -C libs/libft
			@printf "\033[2K\033[0;35mLIBFT:        \033[0;32mCompleted         \033[0;31m----\033[0;0m          │\r\n"
			@make -C libs/ft_printf
			@printf "\033[2K\033[0;35mFT_PRINTF:    \033[0;32mCompleted         \033[0;31m----\033[0;0m          │\r"
			@${CC} ${CFLAGS} ${OBJS} -L ./libs/libft -lft -L ./libs/ft_printf -lftprintf -o ${NAME}
			@printf "\n\033[0;0m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤\n\033[0;35mMINISHELL:    \033[0;32mReady             \033[0;31m----          \033[0;0m│\n⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤\n"
...
clean:
			...
			@${RM} ${OBJS}
			@printf "\033[0;35mPROJECT:      \033[0;32mCleaned\033[0;0m\n"
